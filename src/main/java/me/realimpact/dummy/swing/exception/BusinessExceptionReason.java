...
public enum BusinessExceptionReason implements BusinessExceptionPolicy {
  ...
  PRODUCT_NOT_FOUND_BY_EXT_REF("주어진 상품ID로 상품이 존재하지 않습니다! prod_id = (%s)", HttpStatus.BAD_REQUEST),
  ...
  DATA_INTEGRITY_VIOLATION("데이터가 유효하지 않습니다!", HttpStatus.PRECONDITION_FAILED)
  ;
